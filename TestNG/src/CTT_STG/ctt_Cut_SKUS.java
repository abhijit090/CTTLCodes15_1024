...
//			driver.get("https://development.d36z6oo50ky8dh.amplifyapp.com/login");
	...
	public void Open_Specific_Project() throws InterruptedException {
		...
		WebElement nodeTextElement1 = wait.until(ExpectedConditions
				.elementToBeClickable(By.xpath("//*[contains(text(), 'Controls & Electrical Components')]")));
	...
	public void verify_The_SKU_List_Page_Title_And_Cut_The_SingleSKU() throws InterruptedException {
		...
		Thread.sleep(2000);
		// Click on the node
		WebElement rootnode11 = driver
				.findElement(By.xpath("(//*[contains(text(),'Control Pads, Pendants & Buttons')])[1]"));
