...
//			driver.get("https://development.d36z6oo50ky8dh.amplifyapp.com/login");
		...
		public void verify_The_SKU_List_Page_Title_And_Cut_The_SingleSKU() throws InterruptedException {
			...
			// Locate the div containing the table by its ID
	        WebElement tableContainer = driver.findElement(By.xpath("//div[@id='tablecontainer']"));

	        // Use JavaScript to scroll the div down by 1 cm
	        JavascriptExecutor js = (JavascriptExecutor) driver;
	        js.executeScript("arguments[0].scrollTop += arguments[0].clientHeight * 0.01;", tableContainer);
			//SKU table move up side
//			//shfit the node from up & left side
//			WebElement nodeText1a = driver.findElement(By.xpath("(//div[@class='basicblock'])[1]"));
//			Thread.sleep(1000);
//			WebElement nodeText2 = driver.findElement(By.xpath("//*[@class='project-version']"));
//			Actions actions = new Actions(driver);
//			actions.moveToElement(nodeText1a, 40, 80).clickAndHold().perform();
...
//			select.selectByVisibleText("Alpha code");
//			Thread.sleep(2000);
			
			// Go to the filter by search tab
			driver.findElement(By.xpath("(//input[@id='search'])[1]")).sendKeys("FA9123");
			Thread.sleep(2000);
...
//			 Mouse over to the cut sku node
		...
		// Click on the node
				...
				//Right click 
				WebElement tralaing1 = driver.findElement(By.xpath("(//*[@id='tablecontainer'])/table/tbody/tr[1]/td[1]"));
				Actions actions11 = new Actions(driver);
				actions11.contextClick(tralaing1).perform();
				Thread.sleep(2000);
				// Select the option cretae filter
				...
				WebElement rootnode111 = driver.findElement(By.xpath("(//*[contains(text(),'Control Pads, Pendants & Buttons')])[1]"));
...
//											zoomIn(driver);
				...
				Thread.sleep(3000);
				// verify text
				WebElement successMessage1111 = wait.until(ExpectedConditions
						.visibilityOfElementLocated(By.xpath("(//div[contains(text(),'SKU modified successfully')])[1]")));
				String text1111 = successMessage1111.getText();
