...
public class natalie_Norm_SchemaCheck {
	...
	public void Verify_The_SKu_Schema_Page_open_Or_Not() throws InterruptedException {
		...
		WebElement rootnode11 = wait.until(
				ExpectedConditions.visibilityOfElementLocated(By.xpath("(//*[contains(text(),'Switches')])[3]")));
	...
	public void Verify_The_Double_Space_in_Attribute_Name() throws InterruptedException {
		...
		// ************************QA Error Show***************************
		// mouser over to the QA Error
		WebElement mouseOrSw = wait.until(ExpectedConditions.visibilityOfElementLocated(
				By.xpath("//*[@id=\"myGrid\"]/div[2]/div[2]/div[2]/div[4]/div[1]/div[2]/div/div[1]/div[4]")));
		Actions actions1s = new Actions(driver);
		actions1s.moveToElement(mouseOrSw).perform();
		Thread.sleep(1000);

		// Wait for the error message element to be visible
		WebElement querrormsg = wait.until(ExpectedConditions.visibilityOfElementLocated(
				By.xpath("//*[@id='myGrid']/div[2]/div[2]/div[2]/div[4]/div[1]/div[2]/div/div[1]/div[4]")));
	...
	@Test(priority = 18)
	public void Verify_The_RemoveDuplicate_priority_SecondPriority_Set() throws InterruptedException {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(50));
		// Find the table container element
		WebElement tableContainer = driver.findElement(By.className("ag-center-cols-viewport"));
		// Scroll the table container horizontally to position 500 (adjust as needed)
	...
	public void Verify_The_Missing_Priority() throws InterruptedException {
		...
		// Still end
		// Click on the any schema name in ag grid table
		WebElement skuname1 = wait.until(ExpectedConditions
				.visibilityOfElementLocated(By.xpath("//*[@class='ag-center-cols-container']/div[22]/div[2]")));
		Thread.sleep(2000);
		// scroll to right

		// Scroll horizontally to the right until the end of the table**********
		JavascriptExecutor js11 = (JavascriptExecutor) driver;
		js11.executeScript("var table = document.querySelector('div.ag-center-cols-viewport');"
				+ "table.scrollLeft = table.scrollWidth;");
		Thread.sleep(2000);
		...
		// mouser over to the QA Error
		WebElement mouseOrSw = wait.until(ExpectedConditions.visibilityOfElementLocated(
				By.xpath("//*[@id='myGrid']/div[2]/div[2]/div[2]/div[4]/div[1]/div[2]/div/div[22]/div[4]")));
		Actions actions1s = new Actions(driver);
		actions1s.moveToElement(mouseOrSw).perform();
		Thread.sleep(1000);
	...
	public void Verify_The_Attribute_Name_Hex_Check_Set_secondATTName() throws InterruptedException {
		...
		// mouser over to the QA Error
		WebElement mouseOrSw = wait.until(ExpectedConditions.visibilityOfElementLocated(
				By.xpath("//*[@id=\"myGrid\"]/div[2]/div[2]/div[2]/div[4]/div[1]/div[2]/div/div[2]/div[4]")));
		Actions actions1s = new Actions(driver);
		actions1s.moveToElement(mouseOrSw).perform();
		Thread.sleep(1000);
...
//Pending the missing priority

// 2nd line //*[@id="myGrid"]/div[2]/div[2]/div[2]/div[4]/div[1]/div[2]/div/div[2]......................
			//*[@id="myGrid"]/div[2]/div[2]/div[2]/div[4]/div[1]/div[2]/div/div[1]/div[2]
...
//actions1s1.moveToElement(nodesText).perform();
//Thread.sleep(2000);
