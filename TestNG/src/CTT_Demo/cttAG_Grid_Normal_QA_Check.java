...
//					Thread.sleep(3000);
		...
		public void Verify_The_NumericUOM() throws InterruptedException, TimeoutException {	
			...
			public void Verify_The_Apply_Translation() throws InterruptedException, TimeoutException {	
				...
				Thread.sleep(2000);	
				// Wait for the element to be clickable
				driver.findElement(By.xpath("//div[@class='ag-header-cell ag-header-cell-sortable custom-header-class ag-focus-managed ag-header-active']//span[@class='ag-header-icon ag-header-cell-menu-button']//span[@role='presentation']")).click();
				Thread.sleep(2000);	
				//Click on translate option
